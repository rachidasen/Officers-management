...
<?php endif;?>
  ...
  <?php $attributes = array('id' =>'myform');?>
                  ...
                  <table class="table table-responsive " id="A">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                           <select  class="form-control"    style="width: 100%; height: 100%; border: none; color:#999 ;font-style: italic; font-size: 13px;" name="plannedwork" id="plannedwork"    required >
                      ...
                      <tr>
                        ...
                        <td>
                          ...
                          <select  class="form-control"    style="width: 100%; height: 100%; border: none; color:#999 ;font-style: italic; font-size: 13px;" name="qualityoutput" id="qualityoutput"  required >
                      ...
                      <tr>
                        ...
                        <td>
                          ...
                          <select  class="form-control"    style="width: 100%; height: 100%; border: none; color:#999 ;font-style: italic; font-size: 13px;" name="analytical" id="analytical"  required >
                      ...
                      <tr>
                        ...
                        <td>
                          <select  class="form-control"    style="width: 100%; height: 100%; border: none; color:#999 ;font-style: italic; font-size: 13px;" name="exceptionalwork" id="exceptionalwork"  required >
                  ...
                  <table class="table table-responsive " id="B">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td>
                              <select name="attitudetowork" id="attitudetowork" class="form-control"    style="width: 100%; height: 100%; border: none; color:#999 ;font-style: italic; font-size: 13px;"  required >
                        ...
                        <tr>
                          ...
                          <td>
                            ...
                            <select  name="responsibility" id="responsibility" class="form-control"    style="width: 100%; height: 100%; border: none; color:#999 ;font-style: italic; font-size: 13px;"  required >
                        ...
                        <tr>
                          ...
                          <td>
                            <select  name="discipline" id="discipline" class="form-control"    style="width: 100%; height: 100%; border: none; color:#999 ;font-style: italic; font-size: 13px;"  required >
                        ...
                        <tr>
                          ...
                          <td>
                            ...
                            <select name="communication" id="communication" class="form-control"    style="width: 100%; height: 100%; border: none; color:#999 ;font-style: italic; font-size: 13px;"  required >
                        ...
                        <tr>
                          ...
                          <td>
                            ...
                            <select  name="leadership" id="leadership" class="form-control"    style="width: 100%; height: 100%; border: none; color:#999 ;font-style: italic; font-size: 13px;"  required >
                        ...
                        <tr>
                          ...
                          <td>
                            ...
                            <select name="teamspirit" id="teamspirit" class="form-control"    style="width: 100%; height: 100%; border: none; color:#999 ;font-style: italic; font-size: 13px;"  required >
                        ...
                        <tr>
                          ...
                          <td>
                            ...
                            <select name="timeschedule" id="timeschedule" class="form-control"    style="width: 100%; height: 100%; border: none; color:#999 ;font-style: italic; font-size: 13px;"  required >
                        ...
                        <tr>
                          ...
                          <td>
                            ...
                            <select name="personality" id="personality" class="form-control"    style="width: 100%; height: 100%; border: none; color:#999 ;font-style: italic; font-size: 13px;"  required >
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td>
                          ...
                          <select  class="form-control"   style="width: 100%; height: 100%; border: none; color:#999 ;font-style: italic; font-size: 13px;" name="Knowledgeofrules" id="Knowledgeofrules"  required >
                      ...
                      <tr>
                        ...
                        <td>
                          ...
                          <select  class="form-control"   style="width: 100%; height: 100%; border: none; color:#999 ;font-style: italic; font-size: 13px;" name="strategic" id="strategic"  required >
                      ...
                      <tr>
                        ...
                        <td>
                         ...
                         <select  class="form-control"   style="width: 100%; height: 100%; border: none; color:#999 ;font-style: italic; font-size: 13px;" name="decision" id="decision"  required >
                      ...
                      <tr>
                        ...
                        <td>
                         ...
                         <select  class="form-control"   style="width: 100%; height: 100%; border: none; color:#999 ;font-style: italic; font-size: 13px;" name="coordination" id="coordination"  required >
                      ...
                      <tr>
                        <td><b>Ability to motivate,develop and appraise subordinates</td>
                          ...
                          <select  class="form-control"   style="width: 100%; height: 100%; border: none; color:#999 ;font-style: italic; font-size: 13px;" name="subordinates" id="subordinates"  required >
                      ...
                      <tr>
                        ...
                        <td>
                          ...
                          <select  class="form-control"   style="width: 100%; height: 100%; border: none; color:#999 ;font-style: italic; font-size: 13px;" name="handlingproblems" id="handlingproblems"  required >
                      ...
                      <tr>
                        <td><b>Quality of inspection</td>
                         ...
                         <select  class="form-control"   style="width: 100%; height: 100%; border: none; color:#999 ;font-style: italic; font-size: 13px;" name="inspection" id="inspection"  required >
                      ...
                      <tr>
                        <td><b>Financial propriety</td>
                         ...
                         <select  class="form-control"   style="width: 100%; height: 100%; border: none; color:#999 ;font-style: italic; font-size: 13px;" name="financialpropriety" id="financialpropriety"  required >
   ...
   <?=form_close();?>
    ...
    <div id='conf-msg' class='container-fluid success' style='background-color:green;color:white; padding-right:50px;display:none;'> <center>YOUR FORM HAS BEEN SUBMITTED<a href='#part-3' data-toggle='modal' class='sss rep' style='float:right; color:black;'>view</a></center></div>
  </div>
  ...
  $(document).ready(function(){
    //$(".rev-officer").hide();
     if($("#officer-id").val()==="----"){ 
          ...
          $("#officer-id option:selected").prop('disabled',true);
      }
    ...
    $('#officer-id').on('change',function(){
        alert(<?php if(isset($set)) echo $set; else echo "not set"; ?>);
        var officer_id = $('#officer-id').val();
