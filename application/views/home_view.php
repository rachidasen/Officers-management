              ...
              <?=form_open("Home/new_insert/");?>
                ...
                <?php endif; ?>
                  ...
                  <div class="row container form-group" id="training">UNDERGONE TRAINING
                    <label class="radio-inline" for="yestrain"><input type="radio" id="yestrain" name="response_training"tabindex="7" onclick="javascript:yesorno(this,5);" value="1"<?php if(isset($set)): ?> disabled <?=$response_yes;?> <?php endif;?>>yes</label>
                    <label class="radio-inline" for="inputtrain"><input type="radio" value="0" id="notrain" name="response_training"onclick="javascript:yesorno(this,5);"value="0" tabindex="8"<?php if(isset($set)): ?> disabled <?=$response_no;?><?php endif;?>>no</label>
                ...
                <button type="submit" value="Submit" class="btn btn-primary btn-inline btn-lg" tabindex="7" <?php if(isset($set)) : ?>disabled<?php endif;?>>SUBMIT</button></div>
              <?=form_close()?>
            </div>
          </div>
                  ...
                  <ol type="A">
                    <li>
                      <label class="control-label">
                        Please state briefly, the shortfalls with reference to the targets/objectives/goals referred to in <a href="#">ITEM 2</a>.Please specify the constraints, if any, in achieving the targets.    <textarea class="form-control" name="shortfalls" rows="5"></textarea>
                      </label>
                    </li>
                    <li>
                      <label class="control-label">
                        Please also indicate items in which there have been significantly higher achievements and your contribution thereto <textarea class="form-control" name="higher_achievement" rows="5"></textarea>
                      </label>
                    </li>
                  </ol>
                </li>
